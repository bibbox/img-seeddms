...
RUN curl -L https://netcologne.dl.sourceforge.net/projects/seeddms/files/seeddms-$SEEDDMS_VERSION/SeedDMS_Core-$SEEDDMS_VERSION.tgz > SeedDMS_Core-$SEEDDMS_VERSION.tgz  && \
curl -L https://netcologne.dl.sourceforge.net/projects/seeddms/files/seeddms-$SEEDDMS_VERSION/seeddms-quickstart-$SEEDDMS_VERSION.tar.gz > seeddms-quickstart-$SEEDDMS_VERSION.tar.gz  && \
curl -L https://netcologne.dl.sourceforge.net/projects/seeddms/files/seeddms-$SEEDDMS_VERSION/SeedDMS_Lucene-$LUCENE_VERSION.tgz > seedDMS_Lucene-$LUCENE_VERSION.tgz  && \
curl -L https://netcologne.dl.sourceforge.net/projects/seeddms/files/seeddms-$SEEDDMS_VERSION/SeedDMS_Preview-$PREVIEW_VERSION.tgz > SeedDMS_Preview-$PREVIEW_VERSION.tgz  && \
